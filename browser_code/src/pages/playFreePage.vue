<template>
  <div>
    ...
    <div class="title">自由模式{{mapId}}关</div>
    <el-dialog class="pass-dialog" title="Congratulation!" :visible.sync="passDialogVisible" width="900px" center>
      <pass-free-stage :index="mapId" :blockly="blocklyNum" :shareURL="shareURL"></pass-free-stage>
    </el-dialog>
    <div class="game-page">
      <toolbar></toolbar>
      <div class="map">
      ...
      <div class="coding">
        <blockly ref="blockly" :xmlText="xmlText" v-on:runGame="move" v-on:blockCount="getBlockCount" :blocklies="blocks" :maps="maps" :arrays="array"></blockly>
      </div>
    </div>
  </div>
</template>
...
import passFreeStage from '../components/passFreeStage.vue';
